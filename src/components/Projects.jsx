...
const Projects = () => {
  ...
  return (
    <section className="pt-16" id="projects" ref={projectsRef}>
      <div className="px-4">
        <h2 className="mb-8 text-center text-3xl font-medium lg:text-4xl md:text-4xl">
          Projects
        </h2>
                  ...
                  <div className="mb-4">
                    ...
                    <ul>
                      {project.techStack.map((tech, index) => (
                        <li
                          key={index}
                          className="mb-1 mr-2 mt-1 inline-block rounded-full border-2 border-pink-500 px-3 py-1 text-sm font-semibold"
                        >
                          {tech}
                        </li>
                      ))}
